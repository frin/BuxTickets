...
public class TicketRecord {
	...
	public TicketRecord(int ticketid, String content, String uuid, String owner, String group, String world, double x, double y, double z, String status, String assigned_uuid) {
